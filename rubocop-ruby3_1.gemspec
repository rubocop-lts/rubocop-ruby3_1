...
Gem::Specification.new do |spec|
  ...
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/rubocop/ruby3_1/version.rb", mod) }::Rubocop::Ruby31::Version::VERSION
  spec.authors = ["Peter H. Boling"]
  spec.email = ["floss@galtzo.com"]

  spec.summary = "🦾 Rules for Rubies: Rubocop + Standard + Betterlint + Gradual"
  spec.description = "🦾 Configure RuboCop + a bevy of friends to gradually lint Ruby 3.1 code"
  ...
  spec.metadata["homepage_uri"] = "https://rubocop-ruby3-1.galtzo.com"
  ...
  # The 'git' gem is optional; rubocop-ruby3_1 falls back to shelling out to `git` if it is not present.
