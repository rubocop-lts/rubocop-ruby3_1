...
# kettle-jem:freeze
# To retain chunks of comments & code during rubocop-ruby3_1 templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# rubocop-ruby3_1 will then preserve content between those markers across template runs.
# kettle-jem:unfreeze
